...
// The local bank now relies on authored broad categories only.
...
// Expanded authored categories. These use broad Jeopardy-style topics
...
const lines = [
  '# Generated by tools/generate-jeopardy-source-bank.cjs',
